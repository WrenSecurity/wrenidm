...
//            doc.createElement();
            ...
            value.getAny().add((Element) DOMUtil.parseDocument("<i:accountRef xmlns:i='http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd' type=\"account\" oid=\"8254880d-6584-425a-af2e-58f8ca394bbb\"/>").getFirstChild());
