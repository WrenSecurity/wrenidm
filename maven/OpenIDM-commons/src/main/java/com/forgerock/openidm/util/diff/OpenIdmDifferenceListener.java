 ...
 * @since 0.1
 */
public class OpenIdmDifferenceListener implements DifferenceListener {

    private static final Logger logger = TraceManager.getTrace(OpenIdmDifferenceListener.class);

    public OpenIdmDifferenceListener() {
    }
