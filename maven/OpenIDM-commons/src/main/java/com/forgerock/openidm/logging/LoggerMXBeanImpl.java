...
public class LoggerMXBeanImpl implements LoggerMXBean {
    ...
    private static final int DEFAULT_LOG_LEVEL = Level.INFO_INT;
    ...
    private void updateRootLogger() {
        ...
        org.apache.log4j.Logger rootLogger = org.apache.log4j.Logger.getRootLogger();
        updateAppender(rootLogger);
//        rootLogger.setLevel(Level.WARN);

        org.apache.log4j.Logger loggingLogger = rootLogger.getLoggerRepository().getLogger("com.forgerock.openidm.logging");
        loggingLogger.setLevel(Level.INFO);

//        org.apache.log4j.Logger logger = rootLogger.getLoggerRepository().getLogger(rootPackage);
        org.apache.log4j.Logger logger = rootLogger.getLoggerRepository().getLogger("com.forgerock.openidm");
