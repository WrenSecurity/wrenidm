 ...
 * $Id$
 */
package com.forgerock.openidm.util.jaxb.impl;

import com.forgerock.openidm.util.jaxb.NamespaceEnum;
...
import com.forgerock.openidm.xml.common.Pair;
import java.io.File;
...
public class XMLMarshallerImpl extends Pair<Marshaller, Unmarshaller> implements XMLMarshaller {
    ...
    public XMLMarshallerImpl() throws JAXBException {
        ...
        //b.append(org.forgerock.openidm.xml.persistence.ObjectFactory.class.getPackage().getName());
