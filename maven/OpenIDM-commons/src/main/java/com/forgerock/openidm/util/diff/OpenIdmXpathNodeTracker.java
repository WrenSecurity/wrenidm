 ...
 * @since 0.1
 */
public class OpenIdmXpathNodeTracker extends XpathNodeTracker {
     ...
     * Simple constructor
     */
    public OpenIdmXpathNodeTracker() {
        newLevel();
    }
    ...
    public void visited(Node node) {
        ...
        switch (node.getNodeType()) {
            case Node.ATTRIBUTE_NODE:
                ...
                //OpenIdm patch - Xpath has to have namespace prefix
...
//            } else {
            ...
            if (null != oid) {
                buf.append(XPATH_NODE_INDEX_START).append("@").append(OpenIdmConstants.ATTR_OID_NAME).append("=\"").append(oid).append("\"").append(XPATH_NODE_INDEX_END);
            }
