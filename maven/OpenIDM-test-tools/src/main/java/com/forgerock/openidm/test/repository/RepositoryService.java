...
import com.forgerock.openidm.xml.ns._public.common.common_1.UserListType;
...
public class RepositoryService implements RepositoryPortType {
    ...
    private static final String NS_COMMON = "http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd";
    private static final String NS_DECLARE = "declare namespace c='http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd';\n ";
    ...
    @Override
    public ObjectContainerType getObject(String string, PropertyReferenceListType prlt) throws FaultMessage {
        ...
        try {
            ...
            StringBuilder QUERY = new StringBuilder("declare namespace c='http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd';\n");
            QUERY.append("for $x in //c:object where $x/@oid=\"").append(string).append("\" return $x");
