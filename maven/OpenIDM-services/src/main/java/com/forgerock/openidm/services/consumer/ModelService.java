...
public class ModelService
        ...
        try {
            try {
                ...
                if (null != urlString) {
                    ...
                    url = new URL(baseUrl, "../../../../../wsdl/modelWrapperServices.wsdl");
                }
     ...
     */
    @WebEndpoint(name = "modelPortServicesClient")
    public ModelPortType getModelPort() {
        return super.getPort(new QName("http://openidm.forgerock.com/xml/ns/public/model/model-1.wsdl", "modelPortServicesClient"), ModelPortType.class);
    ...
    public ModelPortType getModelPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://openidm.forgerock.com/xml/ns/public/model/model-1.wsdl", "modelPortServicesClient"), ModelPortType.class, features);
    }
}
