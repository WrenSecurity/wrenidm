...
import com.forgerock.openidm.repository.*;
...
//TODO: solve problem with correct initialization of RepositoryService (Spring) or wait to move out of EJB container ;)
/**
...
public class RepositoryServiceTest {
    ...
    private UserType addUserForTest() throws FaultMessage {
        ...
        String result = instance.addObject(userContainer);
    ...
    //TODO: update test: check all properties, add user before lookup
    /**
    ...
    public void testLookupUser() throws FaultMessage {
        ...
        RepositoryService instance = new RepositoryService();
        instance.setGenericDao(genericDao);
        ObjectContainerType result = instance.getObject(oid, new PropertyReferenceListType());
    ...
    public void testListUsers() throws FaultMessage {
        ...
        RepositoryService instance = new RepositoryService();
        instance.setGenericDao(genericDao);
        ObjectListType result = instance.listObjects(Utils.getObjectType("UserType"));
...
//        property.getProperty().add(prop);
//
//        prop = new PropertyReferenceType();
//        prop.setProperty(Utils.getXsdNameForType(new ObjectFactory(), "Resource"));
//        property.getProperty().add(prop);

        ObjectContainerType objectContainer = instance.getObject("92c058ac-97ce-4d44-a443-4d9b6ad56c1e", property);
        ...
        //TODO: enable after data preparation for tests are fixed
    ...
    public void testGetAccountObject() throws FaultMessage {
        ...
        ObjectContainerType objectContainer = instance.getObject("9de528cb-ada2-4b76-8c4b-122241706987", property);
    ...
    public void testGetResourceObject() throws FaultMessage {
        ...
        ObjectContainerType objectContainer = instance.getObject("d0db5be9-cb93-401f-b6c1-86ffffe4cd5e", property);
        ...
        assertEquals("http://openidm.forgerock.com/schema/resources/instances/ldap/localhostOpenDS", resourceType.getNamespace());
    ...
    public void testGetResourceAccessConfigurationObject() throws FaultMessage {
        ...
        ObjectContainerType objectContainer = instance.getObject("d0db5be9-cb93-401f-b6c1-86ffffe4cd5f", property);
        ...
        assertEquals("http://openidm.forgerock.com/xml/ns/public/resource/idconnector/resourceaccessconfiguration-1.xsd", resourceType.getNamespace());
        assertNotNull(resourceType.getSchema());
    ...
    public void testGetObjectDoesNotExits() {
        ...
        try {
            ObjectContainerType objectContainer = instance.getObject("00000000-0000-0000-0000-000000000000", null);
            AccountShadowType accountType = (AccountShadowType) objectContainer.getObject();
    ...
    public void testListObjects() throws FaultMessage {
        ...
        ObjectListType objectListType = instance.listObjects(Utils.getObjectType("AccountType"));
    ...
    public void testListObjectDoesNotExist() {
        ...
        try {
            ObjectListType objectListType = instance.listObjects("Abcd");
        } catch (FaultMessage ex) {
    ...
    public void testDeleteObject() {
        ...
        try {
            instance.deleteObject("92c058ac-97ce-4d44-a443-4d9b6ad56c1e");
        } catch (FaultMessage ex) {
    ...
    public void testListAccountShadowOwner() throws FaultMessage {
        ...
        UserContainerType userContainer = instance.listAccountShadowOwner("9de528cb-ada2-4b76-8c4b-122241706987");
    ...
    @Test
    public void testListAccountShadowDoeasNotExistOwner() {

        RepositoryService instance = new RepositoryService();
        instance.setGenericDao(genericDao);

        try {
            UserContainerType userContainer = instance.listAccountShadowOwner("00000000-0000-0000-0000-000000000000");
            UserType userType = userContainer.getUser();
            assertNull(userType);
        } catch (FaultMessage ex) {
            if (ex.getFaultInfo() instanceof ObjectNotFoundFaultType) {
    ...
    public void testListResourceObjectShadows() throws FaultMessage {
        ...
        ResourceObjectShadowListType result = instance.listResourceObjectShadows("d0db5be9-cb93-401f-b6c1-86ffffe4cd5e", Utils.getObjectType("AccountType"));
        assertNotNull(result.getObject());
    ...
    public void testListResourceDoesNotExistObjectShadows() {
        ...
        try {
            ResourceObjectShadowListType result = instance.listResourceObjectShadows("00000000-0000-0000-0000-000000000000", Utils.getObjectType("AccountType"));
        } catch (FaultMessage ex) {
            if (ex.getFaultInfo() instanceof ObjectNotFoundFaultType) {
                return;
            }
