 ...
 * $Id$
 */
package com.forgerock.openidm.provisioning.integration.identityconnector.schema;
...
public class ResourceUtils {
     ...
     */
    public ResourceObject buildResourceObject(ConnectorObject connectorObject, ResourceObjectDefinition resourceObjectDefinition) throws OpenIDMException {
