...
import com.forgerock.openidm.exception.IllegalRequestException;
import com.forgerock.openidm.logging.TraceManager;
import com.forgerock.openidm.provisioning.aop.ResourceAccessAspect;
...
import com.forgerock.openidm.provisioning.synchronization.ImportFromResourceTask;
...
public class ProvisioningService implements ProvisioningPortType {
    ...
    public void modifyObject(ObjectModificationType objectChange, ScriptsType scripts, Holder<OperationalResultType> result) throws FaultMessage {
        ...
        try {
            ...
            ObjectContainerType oc = getRepository().getObject(objectChange.getOid(), new PropertyReferenceListType());
...
//        }
    ...
    private void processAccountCredentials(ResourceObject resourceObject, AccountShadowType shadow) throws DOMException {
        ...
        pwd.setTextContent(new String(Base64.decode(((Element) shadow.getCredentials().getPassword().getAny()).getTextContent())));
...
//            resourceAccessConfiguration = getResourceAccessConfiguration(savedResource);
        ...
        try {
            ...
            throw new FaultMessage(resourceOID, null, ex);
        }
    }
     ...
     * @throws FaultMessage
     */
    private void completeResourceObjectShadow(ResourceObjectShadowType shadow) throws FaultMessage, OpenIDMException, com.forgerock.openidm.xml.ns._public.repository.repository_1.FaultMessage {
    ...
    protected void resolveResource(ResourceObjectShadowType shadow) throws com.forgerock.openidm.xml.ns._public.repository.repository_1.FaultMessage {
        if (shadow.getResource() == null) {
            if (shadow.getResourceRef() == null) {
                throw new com.forgerock.openidm.xml.ns._public.repository.repository_1.FaultMessage("Resource and resourceRef are undefined at object(oid=" + shadow.getOid() + "). One of them should be set.", new SchemaViolationFaultType());
            }
            ...
            if (oc == null) {
                throw new OpenIDMException("Invalid resource in object (oid=" + shadow.getOid() + ")");
            }
            ...
            if (any != null && !any.isEmpty()) {
                ...
                for (Element element : any) {
                    ...
                    if (credentials) {
                        ...
                        password.setTextContent(new String(Base64.decode(password.getTextContent())));
    ...
    private ResourceStateType getResourceState(String oid) throws com.forgerock.openidm.xml.ns._public.repository.repository_1.FaultMessage {
    ...
    private ResourceStateType refreshToken(ResourceStateType state, String oid, String resourceName, SynchronizationState syncToken) throws com.forgerock.openidm.xml.ns._public.repository.repository_1.FaultMessage {
    ...
    private ObjectType findOrCreateShadow(ResourceObject identifier, String acctOid, ResourceType resource) throws JAXBException, com.forgerock.openidm.xml.ns._public.repository.repository_1.FaultMessage, FaultMessage {
    ...
    // not finished yet.
    public static final String SEARCH_SHADOW_BY_UUID = "<c:query  xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'" + "    xmlns:c='http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd'" + "    xmlns:dj=\"http://openidm.forgerock.com/xml/ns/samples/localhostOpenDJ\"" + "    xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"" + "    xsi:schemaLocation='http://www.w3.org/2001/XMLSchema ../standard/XMLSchema.xsd" + "    http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd ../../../main/resources/META-INF/wsdl/xml/ns/public/common/common-1.xsd'" + "     xmlns:foo=\"http://foo.com/\">" + "     <c:and>" + "         <c:type uri=\"http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd#AccountShadowType\"/>" + "          <c:equal>" + "             <c:path>c:attributes</c:path>" + "             <c:value>" + "                 <dj:__UID__>cn=foobar,uo=people,dc=nlight,dc=eu</dj:__UID__>" + "             </c:value>" + "          </c:equal>" + "     </c:and>" + " </c:query>";
    public static final String SEARCH_BY_UUID = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "          <c:query  xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'" + "   xmlns:c='http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd'" + "   xmlns:i='http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd'" + "   xmlns:dj=\"http://openidm.forgerock.com/xml/ns/samples/localhostOpenDJ\"" + "   xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\"" + "   xsi:schemaLocation='http://www.w3.org/2001/XMLSchema ../standard/XMLSchema.xsd" + "   http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd ../../../main/resources/META-INF/wsdl/xml/ns/public/common/common-1.xsd'" + "   xmlns:foo=\"http://foo.com/\">" + "    <c:and>" + "        <c:type uri=\"http://openidm.forgerock.com/xml/ns/public/common/common-1.xsd#ResourceStateType\"/>" + "        <c:equal>" + "            <c:value>" + "                <i:resourceRef oid=\"1234\"/>" + "            </c:value>" + "        </c:equal>" + "    </c:and>" + " </c:query>";
