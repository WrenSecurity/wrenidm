...
public class UpdateCommand {
    ...
    public UpdateCommand(CommandSession session,
        ...
        setExecuteSequence(
            PREVIEW_ARCHIVE, ACCEPT_LICENSE, PAUSING_SCHEDULER,
            WAIT_FOR_JOBS_TO_COMPLETE, ENTER_MAINTENANCE_MODE, INSTALL_ARCHIVE,
            WAIT_FOR_INSTALL_DONE);

        // Set the sequence of execution of the recovery steps.
        setRecoverySequence(
            EXIT_MAINTENANCE_MODE, ENABLE_SCHEDULER, FORCE_RESTART);
    }
