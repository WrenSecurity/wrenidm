...
import org.wrensecurity.wrenidm.workflow.flowable.impl.resource.TaskInstanceHistoryResource;
import org.wrensecurity.wrenidm.workflow.flowable.impl.resource.TaskInstanceResource;

/**
 * Request handler providing workflow resources.
 */
public class FlowableResource implements RequestHandler {

    private final Router resources = new Router();

    public FlowableResource(ProcessEngine engine) {
