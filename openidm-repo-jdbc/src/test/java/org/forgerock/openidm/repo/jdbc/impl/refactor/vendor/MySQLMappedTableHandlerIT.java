...
public class MySQLMappedTableHandlerIT extends AbstractMappedTableHandlerTest {
    ...
    protected TableHandler createTableHandler() throws Exception {
        if (LEGACY_MODE) {
            return new org.forgerock.openidm.repo.jdbc.impl.MappedTableHandler(
                    getTableName(),
        ...
        return new MySQLMappedTableHandler(
            getSchemaName(),
            getTableName(),
            getColumnMapping(),
            getQueryConfig(),
