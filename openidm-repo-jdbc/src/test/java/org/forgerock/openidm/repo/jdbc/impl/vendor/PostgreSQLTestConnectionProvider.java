...
public class PostgreSQLTestConnectionProvider extends AbstractTestConnectionProvider {

    @Override
    protected Connection openConnection(boolean first) throws Exception {
        return DriverManager.getConnection(
                "jdbc:tc:postgresql:13.13:///wrenidm?TC_INITSCRIPT=vendor/postgresql.sql",
                "wrenidm",
                "wrenidm");
    }
